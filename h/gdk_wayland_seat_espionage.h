...
int gdk_wayland_seat_espionage_get_version_id() {
...
GdkSeat * gdk_wayland_seat_espionage_get_parent_instance_ptr(GdkWaylandSeat * self) {
  switch (gdk_wayland_seat_espionage_get_version_id()) {
...
gboolean gdk_wayland_seat_espionage_get_nkeys_supported() {
  switch (gdk_wayland_seat_espionage_get_version_id()) {
    case 0: return FALSE;
    case 1: return TRUE;
    case 2: return FALSE;
...
gint32 * gdk_wayland_seat_espionage_get_nkeys_ptr_or_null(GdkWaylandSeat * self) {
  switch (gdk_wayland_seat_espionage_get_version_id()) {
    case 0: return NULL;
